...
// Drawing optical flow vector on an image
...
int main()
{
	...
	cv::Mat frame1= cv::imread("../processing_video_sequences/images/goose/goose230.bmp", 0);
	cv::Mat frame2= cv::imread("../processing_video_sequences/images/goose/goose237.bmp", 0);
    // Combined display
