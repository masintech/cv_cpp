...
// The frame processor inteerface
...
private:
  ...
  // could bee: video file or images
...
public:
  ...
  VideoProcessor()
      : callIt(false), delay(-1), fnumber(0), stop(false), digits(0),
  ...
  void setFrameProcessor(void (*frameProcessingCallback)(cv::Mat &,
                                                         cv::Mat &)) {
